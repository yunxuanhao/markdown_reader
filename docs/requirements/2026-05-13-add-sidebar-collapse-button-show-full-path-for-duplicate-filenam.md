...
- Capsule [e7505444004857e4] Task focus: add sidebar collapse button, show full path for duplicate filenames with ellipsi... Deliverable: Governed implementation artifac...
  Owner: state_store
  Why now: Matched state_store memory for requirement_doc.
  Expansion Ref: /Users/yuanxuan/toys/md_reader/outputs/runtime/vibe-sessions/20260513T154652Z-ca11bd79/memory-activation/skeleton-local-digest.json#e7505444004857e4
  Summary: Task focus: add sidebar collapse button, show full path for duplicate filenames with ellipsi... Deliverable: Governed implementation artifacts, verification evidence, and cleanup receipts. Constraints: Do not bypass the...
  Summary: Git branch: 
